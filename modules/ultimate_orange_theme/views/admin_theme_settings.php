 ...
 */
$enabled = get_option('ultimate_orange_theme_customers'); ?>
<div class="form-group">
    <label for="ultimate_orange_theme_customers" class="control-label clearfix">
        <h5><?= _l('Enable orange Theme for your customers?'); ?></h5>
    </label>
    <div class="radio radio-primary radio-inline">
        <input type="radio" id="y_opt_1_ultimate_orange_theme_customers_enabled" name="settings[ultimate_orange_theme_customers]" value="1" <?= ($enabled == '1') ?' checked' : '' ?>>
        <label for="y_opt_1_ultimate_orange_theme_customers_enabled">
            <?= _l('settings_yes'); ?>
        </label>
    </div>
    <div class="radio radio-primary radio-inline">
        <input type="radio" id="y_opt_2_admin-dark_theme_enabled" name="settings[ultimate_orange_theme_customers]" value="0" <?= ($enabled == '0') ?' checked' : '' ?>>
...
<!-- Select Color -->
<div class="form-group">
    <label for="ultimate_orange_theme_customers_colors" class="control-label clearfix">
