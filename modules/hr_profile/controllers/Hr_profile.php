...
class Hr_profile extends AdminController
{
	...
	// modified function because we changed the fields that we needed to import
	public function import_employees_excel()
	{
		if (!has_permission('hrm_hr_records', '', 'create') && !has_permission('hrm_hr_records', '', 'edit') && !is_admin()) {
			access_denied('hrm_hr_records');
			...
			if (isset($_FILES['file_csv']['name']) && $_FILES['file_csv']['name'] != '') {
				...
				if (!empty($tmpFilePath) && $tmpFilePath != '') {
					...
					if (move_uploaded_file($tmpFilePath, $newFilePath)) {
						...
						// $widths = [40, 40, 40, 50, 40, 40, 40, 40, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50];
						$widths = [40, 40, 40, 50, 40, 40, 40, 40, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50];
						...
						$arr_header['birthday'] = 0;
						$arr_header['dob_original'] = 1;
						$arr_header['blood_group'] = 2;
						$arr_header['phonenumber'] = 3;
						$arr_header['contact_2'] = 4;
						$arr_header['city'] = 5;
						$arr_header['current_address'] = 6;
						$arr_header['pin_code'] = 7;
						$arr_header['e_contact'] = 8;
						$arr_header['e_person'] = 9;
						$arr_header['identification'] = 10;
						$arr_header['pan'] = 11;
						$arr_header['staff_identifi'] = 12;
						$arr_header['firstname'] = 13;
						$arr_header['lastname'] = 14;
						$arr_header['email'] = 15;
						$arr_header['skype'] = 16;
						$arr_header['doj'] = 17;
						$arr_header['doa'] = 18;
						$arr_header['q_bonus'] = 19;
						$arr_header['b_bonus'] = 20;
						$arr_header['f_time'] = 21;
						$arr_header['s_time'] = 22;
						$arr_header['esi_ip'] = 23;
						$arr_header['pf'] = 24;
						$arr_header['medical_insurance'] = 25;
						$arr_header['appointment_letter'] = 26;
						$arr_header['coi_letter'] = 27;
						$arr_header['nda'] = 28;
						$arr_header['policy_document'] = 29;
						$arr_header['bio_enroll'] = 30;
						$arr_header['join_kit'] = 31;
						$arr_header['id_card'] = 32;
						$arr_header['bgv'] = 33;
						$arr_header['departments'] = 34;
						$arr_header['job_position'] = 35;
						$arr_header['team_manage'] = 36;
						$arr_header['role'] = 37;
						$arr_header['user_type'] = 38;
						...
						for ($row = 2; $row < count($data); $row++) {
							...
							$value_birthday = isset($data[$row][$arr_header['birthday']]) ? $data[$row[$arr_header['birthday']]] : '';
							$value_dob_original = isset($data[$row][$arr_header['dob_original']]) ? $data[$row[$arr_header['dob_original']]] : '';
							$value_phonenumber = isset($data[$row][$arr_header['phonenumber']]) ? $data[$row[$arr_header['phonenumber']]] : '';
							$value_contact_2 = isset($data[$row][$arr_header['contact_2']]) ? $data[$row[$arr_header['contact_2']]] : '';
							$value_city = isset($data[$row][$arr_header['city']]) ? $data[$row[$arr_header['city']]] : '';
							$value_current_address = isset($data[$row][$arr_header['current_address']]) ? $data[$row[$arr_header['current_address']]] : '';
							$value_pin_code = isset($data[$row][$arr_header['pin_code']]) ? $data[$row[$arr_header['pin_code']]] : '';
							$value_e_contact = isset($data[$row][$arr_header['e_contact']]) ? $data[$row[$arr_header['e_contact']]] : '';
							$value_e_person = isset($data[$row][$arr_header['e_person']]) ? $data[$row[$arr_header['e_person']]] : '';
							$value_identification = isset($data[$row][$arr_header['identification']]) ? $data[$row[$arr_header['identification']]] : '';
							$value_pan = isset($data[$row][$arr_header['pan']]) ? $data[$row[$arr_header['pan']]] : '';
							$value_staff_identifi = isset($data[$row][$arr_header['staff_identifi']]) ? $data[$row[$arr_header['staff_identifi']]] : '';
							$value_firstname = isset($data[$row][$arr_header['firstname']]) ? $data[$row[$arr_header['firstname']]] : '';
							$value_lastname = isset($data[$row][$arr_header['lastname']]) ? $data[$row[$arr_header['lastname']]] : '';
							$value_email = isset($data[$row][$arr_header['email']]) ? $data[$row[$arr_header['email']]] : '';
							$value_skype = isset($data[$row][$arr_header['skype']]) ? $data[$row[$arr_header['skype']]] : '';
							$value_doj = isset($data[$row][$arr_header['doj']]) ? $data[$row[$arr_header['doj']]] : '';
							$value_doa = isset($data[$row][$arr_header['doa']]) ? $data[$row[$arr_header['doa']]] : '';
							$value_q_bonus = isset($data[$row][$arr_header['q_bonus']]) ? $data[$row[$arr_header['q_bonus']]] : '';
							$value_b_bonus = isset($data[$row][$arr_header['b_bonus']]) ? $data[$row[$arr_header['b_bonus']]] : '';
							$value_f_time = isset($data[$row][$arr_header['f_time']]) ? $data[$row[$arr_header['f_time']]] : '';
							$value_s_time = isset($data[$row][$arr_header['s_time']]) ? $data[$row[$arr_header['s_time']]] : '';
							$value_esi_ip = isset($data[$row][$arr_header['esi_ip']]) ? $data[$row[$arr_header['esi_ip']]] : '';
							$value_pf = isset($data[$row][$arr_header['pf']]) ? $data[$row[$arr_header['pf']]] : '';
							$value_medical_insurance = isset($data[$row][$arr_header['medical_insurance']]) ? $data[$row[$arr_header['medical_insurance']]] : '';
							$value_appointment_letter = isset($data[$row][$arr_header['appointment_letter']]) ? $data[$row[$arr_header['appointment_letter']]] : '';
							$value_coi_letter = isset($data[$row][$arr_header['coi_letter']]) ? $data[$row[$arr_header['coi_letter']]] : '';
							$value_nda = isset($data[$row][$arr_header['birthday']]) ? $data[$row[$arr_header['birthday']]] : '';
							$value_policy_document = isset($data[$row][$arr_header['policy_document']]) ? $data[$row[$arr_header['policy_document']]] : '';
							$value_bio_enroll = isset($data[$row][$arr_header['bio_enroll']]) ? $data[$row[$arr_header['bio_enroll']]] : '';
							$value_join_kit = isset($data[$row][$arr_header['join_kit']]) ? $data[$row[$arr_header['join_kit']]] : '';
							$value_id_card = isset($data[$row][$arr_header['id_card']]) ? $data[$row[$arr_header['id_card']]] : '';
							$value_bgv = isset($data[$row][$arr_header['bgv']]) ? $data[$row[$arr_header['bgv']]] : '';
							$value_departments = isset($data[$row][$arr_header['departments']]) ? $data[$row[$arr_header['departments']]] : '';
							$value_job_position = isset($data[$row][$arr_header['job_position']]) ? $data[$row[$arr_header['job_position']]] : '';
							$value_team_manage = isset($data[$row][$arr_header['team_manage']]) ? $data[$row[$arr_header['team_manage']]] : '';
							$value_role = isset($data[$row][$arr_header['role']]) ? $data[$row[$arr_header['role']]] : '';
							$value_user_type = isset($data[$row][$arr_header['user_type']]) ? $data[$row[$arr_header['user_type']]] : '';
							...
							if (($flag == 1) || $flag2 == 1) {
								...
								$writer->writeSheetRow('Sheet1', [
									...
									$value_esi_ip,
									$value_pf,
									$value_medical_insurance,
									$value_appointment_letter,
									$value_coi_letter,
									$value_nda,
									$value_policy_document,
									$value_bio_enroll,
									$value_join_kit,
									$value_id_card,
									$value_bgv,
							...
							if ($flag == 0 && $flag2 == 0) {
								...
								$rd['birthday'] = $value_birthday;
								$rd['dob_original'] = $value_dob_original;
								$rd['phonenumber'] = $value_phonenumber;
								$rd['contact_2'] = $value_contact_2;
								$rd['city'] = $value_city;
								$rd['current_address'] = $value_current_address;
								$rd['pin_code'] = $value_pin_code;
								$rd['e_contact'] = $value_e_contact;
								$rd['e_person'] = $value_e_person;
								$rd['identification'] = $value_identification;
								$rd['pan'] = $value_pan;
								$rd['staff_identifi'] = $staff_prefix_str . str_pad($staff_next_number, 5, '0', STR_PAD_LEFT);
								$rd['firstname'] = $value_firstname;
								...
								$rd['doj'] = $value_doj;
								$rd['doa'] = $value_doa;
								$rd['q_bonus'] = $value_q_bonus;
								$rd['b_bonus'] = $value_b_bonus;
								$rd['f_time'] = $value_f_time;
								$rd['s_time'] = $value_s_time;
								$rd['esi_ip'] = $value_esi_ip;
								$rd['pf'] = $value_pf;
								$rd['medical_insurance'] = $value_medical_insurance;
								$rd['appointment_letter'] = $value_appointment_letter;
								$rd['coi_letter'] = $value_coi_letter;
								$rd['nda'] = $value_nda;
								$rd['policy_document'] = $value_policy_document;
								$rd['bio_enroll'] = $value_bio_enroll;
								$rd['join_kit'] = $value_join_kit;
								$rd['id_card'] = $value_id_card;
								$rd['bgv'] = $value_bgv;
								$rd['departments'] = $value_departments;
								$rd['job_position'] = $value_job_position;
								$rd['team_manage'] = $value_team_manage;
								$rd['role'] = $value_role;
								$rd['user_type'] = $value_user_type;
	...
	public function add_edit_member($id = '')
	{
		...
		if ($this->input->post()) {
			...
			if ($id == '') {
				...
				// code to stop adding staff if phone number is already in use
				...
				if ($phonenumber) {
					...
					set_alert('danger', 'Phone Number already exists');
					redirect(admin_url('hr_profile/new_member'));
				}
				...
				if (is_array($response)) {
					...
					// update tblstaff_info when hr record is updated
					// $this->hr_profile_model->update_staff_to_staff_info($data,$id);
				}
	...
	public function do_upload()
	{
		...
		if ($this->input->post('userSubmit')) {
			if (!empty($_FILES['userfile']['name'])) {
				...
				$config = array(
					'upload_path' => "./uploads/privacy_policy_upload/",
					'allowed_types' => "pdf",
					'overwrite' => TRUE,
				...
				if ($this->upload->do_upload('userfile')) {
					...
					$pdfName = $uploadData['file_name'];
					// echo '<script>alert("success");</script>';
					// redirect(admin_url('/hr_profile/policy'));
			...
			$userData = array(
				'uploaded_file_name' => $pdfName,
				'date_created' => Date('Y-m-d H:i:s')
			);

			$pdfinserted = $this->db->insert('tblprivacy_policy_documents', $userData);

			if ($pdfinserted) {
				$this->send_email_on_upload();
	...
	// function to send email when new file is uploaded
	public function send_email_on_upload()
	{
		$this->load->library('email');
		$this->email->set_mailtype("html");
		$this->email->from('noreply@tech2globe.com', 'Privacy Policy');
		$this->email->to('bhavya.khanna@tech2globe.in');
        ...
        <head>
            ...
            <title> Check new privacy policy</title>
        </head>
        <body>
            <p><strong>Privacy policy is updated</strong></p>
            <p>Please click on the link to view the updated policy : https://crm.zphotoedit.com/admin/privacy_policy </p>
            
        
            <p><em>Kind Regards,<br>
            T2G Workroom | Tech2globe</em></p>
        </body>
        </html>
        ';
