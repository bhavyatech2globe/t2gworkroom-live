								...
								<div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
									...
									<div class="row">
										<div class="col-md-6">
											...
											<!-- <div class="form-group">
												<label for="blood_group" class="control-label"><?php echo "Blood Group" ?></label>
												<select name="blood_group" data-live-search="true" id="blood_group" class="form-control selectpicker" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
									...
									<div class="row">
										<div class="col-md-6">
											...
											<?php echo render_input('e_contact', 'Emergency Contact Number', ''); ?>
										</div>

										<div class="col-md-6">
											<?php $value = (isset($member) ? $member->e_person : ''); ?>

											<?php echo render_input('e_person', 'Emergency Contact Person', ''); ?>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-6">
											...
											echo render_input('identification', 'Aadhaar card', $identification, 'text'); ?>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="facebook" value="<?php if (isset($member)) {
																													echo html_entity_decode($member->facebook);
																												} ?>">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="linkedin" value="<?php if (isset($member)) {
																													echo html_entity_decode($member->linkedin);
																												} ?>">
											</div>
										</div>
									</div>
