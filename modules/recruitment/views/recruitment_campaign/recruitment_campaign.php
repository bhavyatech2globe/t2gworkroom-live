                  ...
                  <div role="tabpanel" class="tab-pane active" id="general_infor">
                    ...
                    <div class="col-md-6">
                      <label for="position"><small class="req text-danger">* </small> <?php echo _l('position'); ?></label>
                        <select name="cp_position[]" id="position" class="selectpicker" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" multiple required>
                          <option value=""></option>
                          <?php foreach ($positions as $s) {?>
                            <option value="<?php echo html_entity_decode($s['position_id']); ?>"><?php echo html_entity_decode($s['position_name']); ?></option>
                            <?php }?>
