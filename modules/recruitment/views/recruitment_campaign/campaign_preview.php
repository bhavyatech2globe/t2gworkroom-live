      ...
      if ((in_array($curent_user, $manager) || $curent_user == $campaigns->cp_add_from || is_admin())) {
         ...
         <div class=" col-md-3 pull-right">
            <select name="change_status" id="change_status" class="selectpicker dropdown bootstrap-select show-tick bs3"
               ...
               data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('change_status_to'); ?>">

               <option value="1" <?php if ($campaigns->cp_status == 1) {
                  echo 'selected';
               } ?>><?php echo _l('planning'); ?>
               </option>
               <option value="3" <?php if ($campaigns->cp_status == 3) {
                  echo 'selected';
               } ?>><?php echo _l('in_progress'); ?>
               </option>
               <option value="4" <?php if ($campaigns->cp_status == 4) {
                  echo 'selected';
               } ?>><?php echo _l('finish'); ?>
               </option>
               <option value="5" <?php if ($campaigns->cp_status == 5) {
                  echo 'selected';
               } ?>><?php echo _l('cancel'); ?>
               </option>
            ...
            <table class="table border table-striped margin-top-0">
               <tbody>
                  ...
                  <tr class="project-overview">
                     ...
                     <td>
                        <?php echo app_format_money($campaigns->cp_salary_from, $current_id) . ' - ' . app_format_money($campaigns->cp_salary_to, $current_id); ?>
                     </td>
                  </tr>
                  <tr class="project-overview">
            ...
            <table class="table table-striped margin-top-0">
               <tbody>
                  <tr class="project-overview">
                     ...
                     $job_positions = explode(',', $campaigns->cp_position);
                     $position_name_array = array_map('get_rec_position_name', $job_positions);
                     $position_name_str = implode(',', $position_name_array);

                     ?>
                     <td><?php echo $position_name_str ?></td>
                  </tr>
                  <tr class="project-overview">
