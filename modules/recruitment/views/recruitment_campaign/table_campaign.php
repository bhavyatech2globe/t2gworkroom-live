...
$join = [
	'LEFT JOIN tblrec_job_position ON FIND_IN_SET(
        tblrec_job_position.position_id,
        tblrec_campaign.cp_position
    ) ',
...
$where = ['GROUP BY
    tblrec_campaign.cp_id,
    tblrec_campaign.campaign_name,
    tblrec_campaign.cp_position,
    tblrec_campaign.cp_form_work,
    tblrec_campaign.cp_department,
    tblrec_campaign.cp_amount_recruiment,
    tblrec_campaign.cp_status,
    tblrec_campaign.campaign_code,
    tbldepartments.name,
    tblrec_campaign.cp_workplace,
    tblrec_campaign.cp_salary_from,
    tblrec_campaign.cp_salary_to,
    tblrec_campaign.cp_from_date,
    tblrec_campaign.cp_to_date,
    tblrec_campaign.cp_ages_to,
    tblrec_campaign.cp_ages_from,
    tblrec_campaign.cp_height,
    tblrec_campaign.cp_weight,
    tblrec_campaign.cp_job_description,
    tblrec_campaign.cp_reason_recruitment,
    tblrec_campaign.cp_manager,
    tblrec_campaign.cp_follower,
    tblrec_campaign.cp_gender,
    tblrec_campaign.cp_experience,
    tblrec_campaign.cp_literacy,
    tblrec_campaign.cp_proposal,
    tblrec_campaign.rec_channel_form_id,
    tblrec_campaign.display_salary,
    tblrec_campaign.company_id'
];
