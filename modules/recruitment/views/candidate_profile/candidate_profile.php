            ...
            <?php } else { ?>
              ...
              <div class="row">
                ...
                <div class="col-lg-3 pull-right">
                  <select name="rec_campaign[]" id="rec_campaign" class="selectpicker" data-live-search="true"
                ...
                <div class="col-lg-3 pull-right">
                  <select name="change_status[]" id="change_status" class="selectpicker" data-live-search="true"
