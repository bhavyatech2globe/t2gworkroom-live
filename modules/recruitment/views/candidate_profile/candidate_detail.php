			...
			<div class="panel-body">
				...
				<div class="col-md-12">
						...
						<div class="horizontal-tabs">
							<ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
								...
								<!-- <li role="presentation">
									<a href="#other_detail" aria-controls="detail" role="tab" data-toggle="tab" aria-controls="other_detail">
										<span class="glyphicon glyphicon-align-justify"></span>&nbsp;<?php echo 'Other Details'; ?>
									</a>
								</li> -->
								<li role="presentation">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane " id="other_detail">
								...
								<table class="table border table-striped margin-top-0">
									<tbody>
										...
										<tr class="project-overview">
											...
											<td><?php echo html_entity_decode($candidate->current_accommodation); ?>
											</td>
										</tr>
										...
										<tr class="project-overview">
											...
											<td><a
													href="<?php echo html_entity_decode($candidate->facebook); ?>"><?php echo html_entity_decode($candidate->facebook); ?></a>
											</td>
										</tr>
										<tr class="project-overview">
											<td class="bold"><?php echo _l('linkedin'); ?></td>
											<td><a
													href="<?php echo html_entity_decode($candidate->linkedin); ?>"><?php echo html_entity_decode($candidate->linkedin); ?></a>
											</td>
										</tr>
										...
										<tr class="project-overview">
											...
											<td><a
													href="<?php echo html_entity_decode($candidate->skype); ?>"><?php echo html_entity_decode($candidate->skype); ?></a>
											</td>
										</tr>
										<tr class="project-overview">
								...
								<div class="col-md-5 padding-left-right-0">
									<table class="table border table-striped margin-top-0">
										<tbody>
											...
											<tr class="project-overview">
												<td class="bold"><?php echo 'Job Position'; ?></td>
												<td><?php echo get_rec_position_name($candidate->job_position); ?></td>

											</tr>

											<?php if (is_admin() || check_candidate_added_by($candidate->id)): ?>
												<tr class="project-overview">
													<td class="bold"><?php echo 'Package Details'; ?></td>
													<td><?php echo $candidate->package_details; ?></td>
									...
									<table class="table border table-striped margin-top-0">
										<tbody>
											...
											<tr class="project-overview">
												...
												<td><?php echo html_entity_decode($candidate->alternate_contact_number); ?>
												</td>
											</tr>
											<tr class="project-overview">
												<td class="bold"><?php echo _l('email'); ?></td>
												<td><a
														href="mailto:<?php echo html_entity_decode($candidate->email); ?>"><?php echo html_entity_decode($candidate->email); ?></a>
												</td>
											</tr>
											<tr class="project-overview">
												<td class="bold"><?php echo 'Remarks'; ?></td>
												<td><?php echo $candidate->remarks; ?></td>
											</tr>
											<tr class="project-overview">
												<td class="bold"><?php echo 'CV Link'; ?></td>
												<td><a
														href="<?php echo html_entity_decode($candidate->web_view_link); ?>"><?= $candidate->file_name; ?></a>
												</td>
											</tr>
										</tbody>
									</table>
										...
										<?php if (count($data_group) > 0) {
											...
											foreach ($data_group as $key => $gr) {
												...
												<tr>
													...
													<td class="bold text-danger">
														<?php echo html_entity_decode($gr['toltal_percent'] . '%'); ?>
													</td>
													<td class="bold text-danger"></td>
													<td class="bold text-danger">
														<?php echo html_entity_decode($gr['result']); ?>
													</td>
												</tr>
												<?php $count_cr = 1;
