...
function recruitment_add_footer_components() {
	...
	if (!(strpos($viewuri, '/admin/recruitment/view_interviews') === false)) {	
		echo '<script src="' . module_dir_url(RECRUITMENT_MODULE_NAME, 'assets/js/view_interviews.js') .'?v=' . RE_REVISION.'"></script>';
	}
