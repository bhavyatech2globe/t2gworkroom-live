...
(function ($) {
  "use strict";
  initDataTable('.table-table_interview', admin_url + 'recruitment/interviewer_table');
  ...
  $("body").on('click', '.new_interviews', function () {
    ...
    newattachment.find('#interview_heading').html('Round ' + (addMoreInterviewsInputKey + 1));
