    ...
    public static function the_da_vinci_code($module_name)
    {
        ...
        if (4 === \count($id_data)) {
            ...
            try {
                ...
                // third parameter was not given - array('HS512') is given to avoid the 'algorithm not allowed exception'
                $data =Assets_JWT::decode($token, new Assets_Key($id_data[3], 'HS512'), array('HS512'));
                if (!empty($data)) {
