                        ...
                        <div class="col-md-6 noleftrightpadding">
                           <table class="table border table-striped nomargintop">
                              <tbody>
                                 ...
                                 <!-- custom fields view -->
                                 <tr class="project-overview">
                                    <td class="bold"><?php echo 'Graphic Card'; ?></td>
                                    <td><?php echo htmlspecialchars($assets->graphic_card); ?></td>
                                 </tr>
                                 <tr class="project-overview">
                                    <td class="bold"><?php echo 'MAC Address'; ?></td>
                                    <td><?php echo htmlspecialchars($assets->mac_address); ?></td>
                                 </tr>
                                 <tr class="project-overview">
                                    <td class="bold"><?php echo 'MAC Address 2'; ?></td>
                                    <td><?php echo htmlspecialchars($assets->mac_address2); ?></td>
                                 </tr>
                                 <tr class="project-overview">
                                    <td class="bold"><?php echo 'IMEI Number'; ?></td>
                                    <td><?php echo htmlspecialchars($assets->imei_number); ?></td>
                                 </tr>
                                 <tr class="project-overview">
                                    <td class="bold"><?php echo 'IMEI Number 2'; ?></td>
                                    <td><?php echo htmlspecialchars($assets->imei_number2); ?></td>
                                 </tr>
                                 <tr class="project-overview">
                                    <td class="bold"><?php echo 'Operating System'; ?></td>
                                    <td><?php echo htmlspecialchars($assets->operating_system); ?></td>
                                 </tr>
                                 <tr class="project-overview">
                                    <td class="bold"><?php echo 'Office'; ?></td>
                                    <td><?php echo htmlspecialchars($assets->office); ?></td>
                                 </tr>
                                 <tr class="project-overview">
                                    <td class="bold"><?php echo 'Adopter'; ?></td>
                                    <td><?php echo htmlspecialchars($assets->adopter); ?></td>
                                 </tr>
                                 <tr class="project-overview">
                                    <td class="bold"><?php echo 'Vendor Name'; ?></td>
                                    <td><?php echo htmlspecialchars($assets->vendor_name); ?></td>
                                 </tr>
                                 <tr class="project-overview">
                                    <td class="bold"><?php echo 'Bill no.'; ?></td>
                                    <td><?php echo htmlspecialchars($assets->bill_no); ?></td>
                                 </tr>
                              </tbody>
                           </table>
                        </div>
                        <div class="col-md-6 noleftrightpadding">
                           <table class="table table-striped nomargintop">
                              <tbody>
                                 ...
                                 <!-- custom fields view -->
                                 <tr class="project-overview">
                                    <td class="bold"><?php echo 'Make'; ?></td>
                                    <td><?php echo htmlspecialchars($assets->make); ?></td>
                                 </tr>
                                 <tr class="project-overview">
                                    <td class="bold"><?php echo 'Serial No.' ?></td>
                                    <td><?php echo htmlspecialchars($assets->serial_no); ?></td>
                                 </tr>
                                 <tr class="project-overview">
                                    <td class="bold"><?php echo 'Screen Size'; ?></td>
                                    <td><?php echo htmlspecialchars($assets->screen_size); ?></td>
                                 </tr>
                                 <tr class="project-overview">
                                    <td class="bold"><?php echo 'Processor'; ?></td>
                                    <td><?php echo htmlspecialchars($assets->processor); ?></td>
                                 </tr>
                                 <tr class="project-overview">
                                    <td class="bold"><?php echo 'Processor Gen.'; ?></td>
                                    <td><?php echo htmlspecialchars($assets->processor_gen); ?></td>
                                 </tr>
                                 <tr class="project-overview">
                                    <td class="bold"><?php echo 'RAM Gen.'; ?></td>
                                    <td><?php echo htmlspecialchars($assets->ram_gen); ?></td>
                                 </tr>
                                 <tr class="project-overview">
                                    <td class="bold"><?php echo 'RAM Slot no.'; ?></td>
                                    <td><?php echo htmlspecialchars($assets->ram_slot_no); ?></td>
                                 </tr>
                                 <tr class="project-overview">
                                    <td class="bold"><?php echo 'RAM'; ?></td>
                                    <td><?php echo htmlspecialchars($assets->ram); ?></td>
                                 </tr>
                                 <tr class="project-overview">
                                    <td class="bold"><?php echo 'Storage Type'; ?></td>
                                    <td><?php echo htmlspecialchars($assets->storage_type); ?></td>
                                 </tr>
                                 <tr class="project-overview">
                                    <td class="bold"><?php echo 'Storage 1'; ?></td>
                                    <td><?php echo htmlspecialchars($assets->storage_1); ?></td>
                                 </tr>
                                 <tr class="project-overview">
                                    <td class="bold"><?php echo 'Storage 2'; ?></td>
                                    <td><?php echo htmlspecialchars($assets->storage_2); ?></td>
                                 </tr>
