...
<style>
    ...
    #dynamicFilterContainer input select {
        display: inline-flex;
        width: 150px;
        /* Adjust as needed */
    }
    ...
    function customFilterSearch() {
        ...
        projectTable.columns().every(function(index) {
            ...
            if (isDateColumn(title)) {
                ...
                input = $('<div class="filter-row"><label for="filter_' + index + '">Status: </label><select id="activeInactive" class="form-control"><option value="">All</option><option name ="exclude_inactive" value="1">Active</option><option value="0">Inactive</option></select></div>')
                    .appendTo($('#dynamicFilterContainer'));
