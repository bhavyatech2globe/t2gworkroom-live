            ...
            <div class="col-md-12">
                <div class="_buttons">
                    <?php if (has_permission('contracts', '', 'create')) { ?>
                        <a href="<?php echo admin_url('contracts/contract'); ?>" class="btn btn-primary pull-left display-block tw-mb-2 sm:tw-mb-4">
                    ...
                    <div id="contract_summary">
                        ...
                        <div class="tw-grid tw-grid-cols-2 md:tw-grid-cols-3 lg:tw-grid-cols-5 tw-gap-2">
                            ...
                            <div class="tw-flex tw-items-center md:tw-border-r md:tw-border-solid tw-flex-1 md:tw-border-neutral-300 lg:tw-border-0">
                                <span class="tw-font-semibold sm:tw-w-auto tw-mr-3 rtl:tw-ml-3 tw-text-lg">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-6">
                                <h4 class="tw-font-semibold tw-mb-8">
                                    ...
                                    (<span data-toggle="tooltip" data-title="<?php echo _l('base_currency_string'); ?>" class="text-has-action">
