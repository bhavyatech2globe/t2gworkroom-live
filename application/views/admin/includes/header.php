...
<div id="header">
    ...
    if ($type_check_in_out == 1) {
        ...
        $html_list = '<div class="row"><div class="col-md-12"><div class="alert alert-success">Check in : ' . Date('h:i:s A', strtotime($data_check_in_out[0]['date'])) . '</div></div></div>';
            ...
            <div class="tw-flex tw-flex-1 sm:tw-flex-initial">
                ...
                <ul class="nav navbar-nav visible-md visible-lg">
                    ...
                    <li>
                        ...
                        <a href="/admin/privacy_policy">Company Policies</a>
                    ...
                    <li id='checkOutBtn' class="icon dropdown tw-relative tw-block notifications-wrapper header-notifications rtl:tw-ml-3 check-time-btn" style="width: 10%; padding: 13px 10px;">
