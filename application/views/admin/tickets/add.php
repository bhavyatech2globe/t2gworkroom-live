        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tw-flex tw-items-center tw-mb-2">
                    ...
                    <!-- swapped hide class to  make no contact default and hidden to contact -->
                    <?php if (!isset($project_id) && !isset($contact)) { ?>
                        <!-- <a href="#" id="ticket_no_contact" class="label label-default">
                            <i class="fa-regular fa-envelope tw-mr-1"></i> <?php //Secho _l('ticket_create_no_contact'); ?>
                        </a>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group select-placeholder" id="ticket_contact_w" style="display: none;">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <?php echo render_input('name', 'ticket_settings_to', '', 'text',['required' => true] ); ?>

                                    </div>
                                    <div class="col-md-6">
                                        <?php //echo render_input('email', 'ticket_settings_email', '', 'email', ['disabled' => true]); ?>
                                        <?php echo render_input('email', 'ticket_settings_email', '', 'email',['required' => true]); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <?php echo render_select('department', $it_department, ['departmentid', 'name'], 'ticket_settings_departments', $it_department[0]['departmentid'], ['required' => 'true']); ?>
