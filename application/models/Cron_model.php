...
class Cron_model extends App_Model
{
    ...
    public function consecutive_three_days_email($consecutive_three_days)
    {
        ...
        try {
            ...
            $this->email->cc(array('ishan.negi@tech2globe.in', 'bhavya.khanna@tech2globe.in', 'naved.ahamad@tech2globe.in', 'sarabjeet@tech2globe.com', 'bhavyakhanna.tech2globe@gmail.com'));
    ...
    public function it_asset_weekly_email($staff_assets)
    {
        ...
        try {
            ...
            $subject = "Weekly IT Asset Allocation Report";
